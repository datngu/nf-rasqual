...
process EXTERNAL_LD_SPLIT_chromosome {
    ...
    publishDir "${params.trace_dir}/EXTERNAL_LD_SPLIT_chromosome", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process EXTERNAL_LD_eigenMT_process_input {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_eigenMT_process_input", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process EXTERNAL_LD_ATAC_eigenMT_process_input {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_ATAC_eigenMT_process_input", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process EXTERNAL_LD_ATAC_eigenMT{
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_ATAC_eigenMT_results", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process EXTERNAL_LD_ATAC_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_ATAC_eigenMT_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process EXTERNAL_LD_ATAC_MERGE_rasqual_normial {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_ATAC_MERGE_rasqual_normial", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process EXTERNAL_LD_ATAC_MERGE_rasqual_normial_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/EXTERNAL_LD_ATAC_MERGE_rasqual_normial_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
