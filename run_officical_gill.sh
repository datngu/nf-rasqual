...
run_nextflow () {
  ...
  # genotype
  genotype=/mnt/project/Aqua-Faang/dat/wgs_504/12_samples_genotype_filtered_on_504.vcf.gz
  # LD genotype
  ld_genotype=/mnt/project/Aqua-Faang/dat/wgs_504/ALL_chrome_phased_filtered_HWE_1e6_biSNPs_MAF_0.01.vcf.gz
  # atac
