...
include { ATAC_MERGE_rasqual_normial; ATAC_MERGE_rasqual_normial_permute; ATAC_GET_lead_SNP; ATAC_GET_lead_SNP_permute; RNA_MERGE_rasqual_normial; RNA_MERGE_rasqual_normial_permute; RNA_GET_lead_SNP; RNA_GET_lead_SNP_permute } from './module/get_lead_snp'
...
workflow {
    ...
    if( params.atac_qtl ){
        ...
        if(params.external_ld){
            ...
            ATAC_MERGE_rasqual_normial(ATAC_rasqual_TO_eigenMT.out.collect())
            ATAC_GET_lead_SNP(ATAC_MERGE_eigenMT.out, ATAC_MERGE_rasqual_normial.out)
            ...
            ATAC_MERGE_rasqual_normial_permute(ATAC_rasqual_TO_eigenMT_permute.out.collect())
            ATAC_GET_lead_SNP_permute(ATAC_MERGE_eigenMT_permute.out, ATAC_MERGE_rasqual_normial_permute.out)
    ...
    if( params.eqtl_qtl ){
        ...
        if(params.external_ld){
            ...
            RNA_MERGE_rasqual_normial(RNA_rasqual_TO_eigenMT.out.collect())
            RNA_GET_lead_SNP(RNA_MERGE_eigenMT.out, RNA_MERGE_rasqual_normial.out)
            ...
            RNA_MERGE_rasqual_normial_permute(RNA_rasqual_TO_eigenMT_permute.out.collect())
            RNA_GET_lead_SNP_permute(RNA_MERGE_eigenMT_permute.out, RNA_MERGE_rasqual_normial_permute.out)
...
process ATAC_BAM_rename {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_bam_dir", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_BAM_rename {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_bam_dir", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_ADD_AS_vcf {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_AS_vcf", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_ADD_AS_vcf {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_AS_vcf", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_FILTERING_expression {
    ...
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_filtering_expression", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process GTF_GENE_INFO_parser {
    ...
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/gene_info", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_FILTERING_expression {
    ...
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_filtering_expression", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_PROCESS_covariates {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_covariates", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_PROCESS_covariates {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_covariates", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_SPLIT_chromosome {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_split_chrom", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_SPLIT_chromosome {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_split_chrom", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_PREPROCESS_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_qtl_input", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 8
...
process RNA_PREPROCESS_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_qtl_input", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 8
...
process ATAC_RUN_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_RUN_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_MERGE_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_merged", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process RNA_MERGE_rasqual {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_merged", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process ATAC_RUN_rasqual_permutation {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_permutaion", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_RUN_rasqual_permutation {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_permutaion", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_MERGE_rasqual_permutation {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_permutaion_merged", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process RNA_MERGE_rasqual_permutation {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_permutaion_merged", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process ATAC_COMPUTE_rasqual_emperical_pvalues {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_emperical_pvalues", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process RNA_COMPUTE_rasqual_emperical_pvalues {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_emperical_pvalues", mode: 'symlink', overwrite: true
    memory '8 GB'
    cpus 1
...
process ATAC_eigenMT_process_input {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_eigenMT_process_input", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_eigenMT_process_input {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_eigenMT_process_input", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_RUN_rasqual_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_eigenMT", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_RUN_rasqual_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_eigenMT", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_RUN_rasqual_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_eigenMT_permute", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_RUN_rasqual_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_eigenMT_permute", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_rasqual_TO_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_eigenMT_processed", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_rasqual_TO_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_eigenMT_processed", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_rasqual_TO_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_results_rasqual_eigenMT_processed_permute", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process RNA_rasqual_TO_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_results_rasqual_eigenMT_processed_permute", mode: 'symlink', overwrite: true
    memory '64 GB'
    cpus 16
...
process ATAC_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_eigenMT_results", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_eigenMT {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_eigenMT_results", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process ATAC_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/ATAC_eigenMT_results_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
...
process RNA_eigenMT_permute {
    container 'ndatth/rasqual:v0.0.0'
    publishDir "${params.trace_dir}/RNA_eigenMT_results_permute", mode: 'symlink', overwrite: true
    memory '8 GB'
